...
echo ""
echo "  dilxc shell                # shell into the container"
echo "  dilxc sync                 # copy project source to working dir"
echo "  dilxc claude               # start Claude Code (autonomous)"
echo "  dilxc claude-run \"prompt\"   # one-shot Claude Code"
echo "  dilxc claude-resume        # resume last session"
echo "  dilxc snapshot <name>      # btrfs snapshot"
echo "  dilxc restore <name>       # instant rollback"
echo "  dilxc pull <path> [dest]   # pull files to host"
echo "  dilxc health-check         # verify everything works"
echo ""
